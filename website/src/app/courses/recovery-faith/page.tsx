...
// Example: recovery-faith → NEXT_PUBLIC_STRIPE_URL_recovery_faith
const CHECKOUT_URL = process.env.NEXT_PUBLIC_STRIPE_URL_recovery_faith || "#";

export const metadata = {
  title: "Faith in Hard Times — Recovery Series",
  description: "Focused 30-minute lesson + workbook. Faith-based recovery: Faith in Hard Times.",
};
    ...
    <main className="min-h-screen bg-white text-[#3B3B3B]">
      <section className="bg-gradient-to-b from-[#7C3AED] via-[#8B5CF6] to-[#6D28D9]">
        <div className="mx-auto max-w-6xl px-6 py-14 text-white">
          <h1 className="text-3xl md:text-4xl font-extrabold">Faith in Hard Times</h1>
