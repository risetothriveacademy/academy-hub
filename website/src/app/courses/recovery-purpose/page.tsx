...
// Example: recovery-purpose → NEXT_PUBLIC_STRIPE_URL_recovery_purpose
const CHECKOUT_URL = process.env.NEXT_PUBLIC_STRIPE_URL_recovery_purpose || "#";

export const metadata = {
  title: "Purpose & Calling — Recovery Series",
  description: "Focused 30-minute lesson + workbook. Faith-based recovery: Purpose & Calling.",
};
    ...
    <main className="min-h-screen bg-white text-[#3B3B3B]">
      <section className="bg-gradient-to-b from-[#7C3AED] via-[#8B5CF6] to-[#6D28D9]">
        <div className="mx-auto max-w-6xl px-6 py-14 text-white">
          <h1 className="text-3xl md:text-4xl font-extrabold">Purpose & Calling</h1>
