  ...
  return (
    <div className="min-h-screen bg-slate-950 px-4 py-16 max-w-3xl mx-auto">
      ...
      <p className="mt-4 text-lg text-slate-200">
        This is a temporary placeholder for your 5-Day Foundation Course.
        The full lesson portal (Day 1–5, videos, workbooks, and progress)
        will be wired in here from the backup project.
      </p>
