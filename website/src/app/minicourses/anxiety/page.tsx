...
const CHECKOUT_URL = process.env.NEXT_PUBLIC_STRIPE_URL_anxiety || "#";

export const metadata = {
  title: "Why Anxiety Won't Let Go — Mini-Course",
  description: "Focused 30-minute lesson + workbook. Faith-based recovery: Why Anxiety Won't Let Go.",
};
    ...
    <main className="min-h-screen bg-white text-[#3B3B3B]">
      <section className="bg-gradient-to-b from-[#0097B2] via-[#0EA5E9] to-[#10B981]">
        <div className="mx-auto max-w-6xl px-6 py-14 text-white">
          <h1 className="text-3xl md:text-4xl font-extrabold">Why Anxiety Won't Let Go</h1>
        ...
        <div className="md:col-span-2 space-y-6">
          <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-3 aspect-video w-full rounded-xl bg-gradient-to-br from-[#0097B220] to-[#10B98120] flex items-center justify-center text-gray-500">
              Video embed coming soon — Course 18: Why Anxiety Won't Let Go
            </div>
          </div>
          <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
